...
export default {
  ...
  render: function render(h, ctx) {
    var _ctx$props = ctx.props,
        abstract = _ctx$props.abstract,
        bordered = _ctx$props.bordered,
        hoverable = _ctx$props.hoverable,
        narrow = _ctx$props.narrow,
        size = _ctx$props.size,
        striped = _ctx$props.striped;

    var _ = styleResolver(ctx.$style);

    var styles = [_('table'), bordered && _('is-bordered'), hoverable && _('is-hoverable'), narrow && _('is-narrow'), size && _('is-' + size), striped && _('is-striped')];
