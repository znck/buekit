...
export default {
  ...
  render: function render(h, ctx) {
    ...
    var _ctx$props = ctx.props,
        ...
        outlined = _ctx$props.outlined,
        inverted = _ctx$props.inverted,
        hovered = _ctx$props.hovered,
        focused = _ctx$props.focused,
        active = _ctx$props.active,
        loading = _ctx$props.loading,
        disabled = _ctx$props.disabled;
    return style(h(tag, ctx.data, ctx.children), _('button'), color && _("is-" + color), outlined && _('is-outlined'), inverted && _('is-inverted'), hovered && _('is-hovered'), focused && _('is-focused'), active && _('is-active'), loading && _('is-loading'), ctx.props.static && _('is-static'), disabled && _('is-disabled'));
  }
};
</script>
