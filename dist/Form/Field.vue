...
export default {
  ...
  render: function render(h, ctx) {
    ...
    var _ctx$props = ctx.props,
        ...
        help = _ctx$props.help;

    var _ctx$slots = ctx.slots(),
        slotLABEL = _ctx$slots.label,
        slotHELP = _ctx$slots.help,
        _ctx$slots$default = _ctx$slots.default,
        content = _ctx$slots$default === void 0 ? [] : _ctx$slots$default;

    return style(h('div', ctx.data, [(label || slotLABEL) && h('label', {
      class: [_('label'), size && _("is-" + size)]
    }, slotLABEL || label)].concat(content, [(help || slotHELP) && h('p', {
      class: [_('help'), color && _("is-" + color)]
    }, slotHELP || help)])), _('field'));
  }
};
</script>
