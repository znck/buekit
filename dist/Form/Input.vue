...
export default {
  ...
  render: function render(h, ctx) {
    var _ctx$$style = ctx.$style,
        $style = _ctx$$style === void 0 ? {} : _ctx$$style,
    ...
    if (!props.textarea) {
      data.attrs = _extends({}, toObject(data.attrs), {
    ...
    }].concat(toArray(data.on && data.on.input));
    return style(h(props.textarea ? InputTextarea : InputText, data), _(props.textarea ? 'textarea' : 'input'), input.styles(props, $style));
  }
};
</script>
